...
public class Renderer2dBatch {
    public static Renderer2dBatch instance;
    ...
    public Renderer2dBatch() throws Exception{
        instance = this;
    ...
    public void setupMesh(){
        ...
        shader.set1f("uAspectRatio", (float)Launcher.getWindow().getWidth() / Launcher.getWindow().getHeight());
        shader.unbind();
    }
    ...
    public void flushBatch(){
        ...
        shader.bind();
        shader.setMat4f("uProjection", Launcher.getWindow().updateProjection(Player.instance.camera.getViewMatrix()));
